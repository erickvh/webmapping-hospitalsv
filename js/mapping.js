...
var publicosLayer = L.geoJSON(publicos, {
    ...
    onEachFeature: function (feature, layer) {
        ...
        "<p>"+feature.properties.telefono_1+"</p>"+
        "<p>"+((feature.properties.telefono_2==null)? "No Disponible":feature.properties.telefono_2)+"</p>"+
        "<p>"+((feature.properties.telefono_3==null)? "No Disponible":feature.properties.telefono_3)+"</p>"
...
var privadosLayer = L.geoJSON(privados, {
    ...
    onEachFeature: function (feature, layer) {
        layer.bindPopup("<p>" + feature.properties.hospital + "</p>" +
            "<p>" + feature.properties.hospital + "</p>"+
            "<p>" + feature.properties.direccion + "</p>"+
            "<p>"+feature.properties.telefono_1+"</p>"+
            "<p>"+((feature.properties.telefono_2==null)? "No Disponible":feature.properties.telefono_2)+"</p>"+
            "<p>"+((feature.properties.telefono_3==null)? "No Disponible":feature.properties.telefono_3)+"</p>"
